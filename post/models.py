...
class Channels(models.Model):
    ...
    category = models.ForeignKey(CategoriyChanels, on_delete=models.SET_NULL, related_name='cat_channels', null=True,blank=True)
    slug = models.SlugField(max_length=100, unique=True)
...
class Post(models.Model):
    ...
    sales = models.ForeignKey(CustomUser, related_name='sales_posts', on_delete=models.SET_NULL, null=True, blank=True)
    content = models.ForeignKey(CustomUser, related_name='content_posts', on_delete=models.SET_NULL, null=True, blank=True)
