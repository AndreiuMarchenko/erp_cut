...
urlpatterns = [
    ...
    path(
        "detail_post/<slug:slug>/<int:id>/",
        views.DetailPost.as_view(),
        name="detailPost",
    ),
    # AUTOPOSTING
    path(
        "editor/<slug:slug>/<int:post_channel_id>/",
        views.EditorPostView.as_view(),
        name="editor",
    ),
    path(
        "save-to-avtoposting/<int:post_chanel_id>/",
        views.save_to_avtoposting,
        name="save_to_avtoposting",
    ),
    path(
        "delete-to-avtoposting/<int:post_chanel_id>/",
        views.delete_to_avtoposting,
        name="delete_to_avtoposting",
    ),
